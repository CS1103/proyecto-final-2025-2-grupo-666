...
## 2.4 Pipeline Experimental (`TrainingPipeline.h`)
...
## 2.5 Manual de uso y casos de prueba
...
### 2.5.2 Comandos de Caso de Prueba
...
## 4.2. Métricas del Pipeline Experimental
